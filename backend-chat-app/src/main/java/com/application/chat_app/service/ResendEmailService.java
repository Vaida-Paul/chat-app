...
public class ResendEmailService {
    ...
    private String buildEmailTemplate(String title, String heading, String message,
        ...
        return """
                            ...
                            <table width="100%" style="max-width:420px; background:#0f172a; border-radius:12px; border:1px solid #1e293b;">
                                ...
                                <tr>
                                    <td style="padding:20px; text-align:center;">
                                        <div style="font-size:16px; font-weight:600; color:#f9fafb; margin-bottom:10px;">%s</div>
                                        <div style="font-size:13px; color:#9ca3af; line-height:1.5; margin-bottom:20px;">%s</div>
                                        <a href="%s"
                                           style="display:inline-block; padding:10px 18px; font-size:13px; font-weight:600; color:#ffffff; background-color:#6366f1; text-decoration:none; border-radius:6px;">%s</a>
                                        <div style="margin-top:20px; font-size:11px; color:#6b7280;">%s</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:14px; text-align:center; border-top:1px solid #1e293b;">
                                        <div style="font-size:11px; color:#6b7280;">
                                            © 2026 Echo ·
                                            <a href="%s" style="color:#9ca3af; text-decoration:none;">Privacy</a>
                                        </div>
                                    </td>
                                </tr>
                            </table>
            ...
            """.formatted(title, logoUrl, heading, message, buttonLink, buttonText, footerNote, privacyLink);
    }
}
